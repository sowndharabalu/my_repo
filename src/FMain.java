...
class FoodDeliveryPlatform{
    ...
    private final PriorityQueue<Order2> pendingOrders=new PriorityQueue<>();
...
public class FMain {
    public static void main(String[] args) {
        ...
        List<Order2> orders = List.of(
                ...
                new Order2("ORD004",103,1,r1.getMenu(),5),
        ...
        fd.processNextOrder().stream().sorted(Comparator.naturalOrder()).forEach(System.out::println);
        ...
        String a3=fd.assignAgent().orElse(null);
        fd.releaseAgent(a2);
        fd.assignAgent();
